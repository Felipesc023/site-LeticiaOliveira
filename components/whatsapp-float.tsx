...
/** Floating WhatsApp entry point (DESIGN.md §25). Kept minimal — no repeated
    "fale no WhatsApp" copy, just the mark. */
export function WhatsappFloat() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 flex h-12 w-12 items-center justify-center border border-espresso bg-espresso text-canvas transition-colors hover:bg-espresso-deep"
    >
