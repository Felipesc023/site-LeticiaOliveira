...
export function WhatsappFloat() {
  ...
  return (
    ...
    >
      <span
        className="flex h-12 w-12 items-center justify-center bg-[#25D366] text-white transition-transform duration-300 group-hover:scale-110 group-active:scale-95"
        style={{
          borderRadius: "9999px",
          animation: "ring-pulse 2.2s ease-out 3",
          boxShadow: "0 8px 20px -8px rgba(37,211,102,0.6)",
        }}
      >
